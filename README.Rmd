...
I extracted the bibtex from each paper with a doi using the package [rcrossref](https://github.com/ropensci/rcrossref). The default setting was used since it has complete names for all authors. The code for this step can be found in [`02_r/extract_bib`](https://github.com/palolili23/pubmed_webscrap/blob/master/02_r/extract_bib.R).

Once every paper with the specific bibtex information, these are the next steps to clean the data: 
